...
-- same as original except it exposes crosshairStrokeColor
--------------------------------------------------------------------------------
...
registerWidget("Nice_Crosshairs2");

--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
function Nice_Crosshairs2:initialize()
    ...
    widgetCreateConsoleVariable("a", "int", 255);

    widgetCreateConsoleVariable("ra", "int", 255);
	widgetCreateConsoleVariable("ga", "int", 255);
	widgetCreateConsoleVariable("ba", "int", 255);
    widgetCreateConsoleVariable("aa", "int", 255);
...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
--function Nice_Crosshairs2:finalize()
--end

--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
function Nice_Crosshairs2:draw(forceDraw)
    ...
    local crosshairStrokeColor = Color(widgetGetConsoleVariable("ra"), widgetGetConsoleVariable("ga"), widgetGetConsoleVariable("ba"), widgetGetConsoleVariable("aa"));
    ...
    crosshairFillColor.a = widgetGetConsoleVariable("a");
...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
function Nice_Crosshairs2:drawOptions(x, y, intensity)
	local optargs = {};
...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
function Nice_Crosshairs2:getOptionsHeight()
