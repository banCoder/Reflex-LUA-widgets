...
function AccelMeter:settings()
  consolePerformCommand("ui_show_widget AccelMeter")
  consolePerformCommand("ui_set_widget_anchor AccelMeter 0 0")
  consolePerformCommand("ui_set_widget_offset AccelMeter 0 " .. radius)
  consolePerformCommand("ui_set_widget_scale AccelMeter 1")
end
